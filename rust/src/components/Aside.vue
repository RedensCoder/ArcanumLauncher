<template>
        <aside class="aside"> 
            <div class="flex">
                <div class="profile">
                        <img src="https://webmg.ru/wp-content/uploads/2022/06/i-268.jpeg" alt="no avatar" class="avatar">
                ...
                <div class="navbar">
                        <div class="nb_lib">
                            ...
                            <routerLink to="/lib">Библиотека</routerLink>
                        </div>
                        <div class="nb_lib">
                        ...
                        <div class="nb_lib">
                            ...
                            <routerLink to="/friends">Друзья</routerLink>
                        </div>
                        <div class="nb_lib">
